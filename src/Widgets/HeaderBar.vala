...
public class Twitter.Widgets.HeaderBar : Hdy.HeaderBar {
    ...
    construct {
        ...
        var preferences_accellabel = new Granite.AccelLabel.from_action_name (
            _("Preferences…"),
            Twitter.Services.ActionManager.ACTION_PREFIX + Twitter.Services.ActionManager.ACTION_PREFERENCES
        );

        var preferences_menu_item = new Gtk.ModelButton () {
            action_name = Twitter.Services.ActionManager.ACTION_PREFIX + Twitter.Services.ActionManager.ACTION_PREFERENCES
        };
        ...
        var quit_accellabel = new Granite.AccelLabel.from_action_name (
            _("Quit"),
            Twitter.Services.ActionManager.ACTION_PREFIX + Twitter.Services.ActionManager.ACTION_QUIT
        );

        var quit_menu_item = new Gtk.ModelButton () {
            action_name = Twitter.Services.ActionManager.ACTION_PREFIX + Twitter.Services.ActionManager.ACTION_QUIT
        };
